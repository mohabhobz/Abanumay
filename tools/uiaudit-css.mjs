...
/* السلالم المعرَّفة في `:root`.
   ⚠️ لازم تتغيّر مع `:root` · الأرقام هنا كانت لسّه ١٠/١٥/٢٢/٢٨
   بعد ما السلّم بقى ١٢/١٦/٢٤/٣٢، فالفحص كان بيدوّر على قيم مش
   موجودة أصلًا ويطلع أخضر. الفحص اللي بيقيس حاجة ما فيش بيرجع
   نضيفًا دايمًا. */
const SCALE = {
  /* السلّم اتلمّ: `--r1` بقت ١٦ بطلب العميل، فبقت هي و`--r2`
     نفس الرقم باسمين · فاترقّمت الدرجات من جديد، و١٢ فضلت
     كدرجة **صندوق الأيقونة** (`--ric`) لأن صندوق ٣٢ بركن ١٦
     بيبقى دايرة. */
  radius: { '4px': '--r0', '12px': '--ric', '16px': '--r1', '24px': '--r2', '32px': '--r3', '999px': '--rp' },
}
