...
const NOT_ICONS = [
  ...
  /* الخطوط الواصلة في انفوجرافيك الجهة · **رسم لا أيقونة**: مسارات
     بزوايا قائمة ونقط عند أطرافها، زي مروحة الاعتماد والرسوم
     البيانية بالظبط. مفيش أيقونة في لوسيد تعمل ده، والاستثناء هنا
     بيتكتب باسم الملف عشان أي `svg` تانية فيه تفضل تتمسك. */
  'features/entities/EntityFlow.tsx',             // خطوط الانفوجرافيك
]
