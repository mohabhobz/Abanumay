/**
 * مشاريع تجريبية — ٣٠ صفًّا بشكل جدول المشاريع في النظام.
 *
 ...
 * ده اللي الأوديت طلعه من ٤٬٩٢٩ مشروعًا، ولازم يبان في الواجهة.
 */
...
export const projectRows: ProjectRow[] = [
  ...
  mk({
    id: '20968',
    name: 'تأهيل ٤٠ معلمًا لحلقات التحفيظ',
    entityId: '733',
    track: 'المنح النوعي',
    field: 'القرآن',
  ...
  mk({
    id: '20852',
    name: 'علاج ٦٠ من مرضى الكلى بالأحساء',
    entityId: '755',
    track: 'مسار تعميق الأثر',
    field: 'مجال الصحة',
  ...
  // ── معتذر عنه: ٧٥٪ من النظام. الأهم هنا هو **سبب** الاعتذار ──
  mk({
    id: '20512',
 ...
 * موجودة عشان تجربة «١٬٢٥٣ مشروعًا بلا مالك» تتجرّب فعلًا لا تتخيّل؛
