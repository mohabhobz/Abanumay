...
export interface PlanNode {
  id: string
  label: string
  /** المبلغ المخصص لهذا البند */
  alloc: number
  /** خطة الإنجاز % — بتدخل في حساب «نسبة الإنجاز من الخطة الإستراتيجية» */
  plan: number
  /** مالك البند (مولَّد) */
  owner?: string
...
const g = (rows: G[], owner: string): PlanNode[] =>
  rows.map(([label, alloc, reserved, spent], i) => ({
    id: `${owner}-${i}-${label}`,
    label, alloc, plan: 100, owner, reserved, spent,
  }))
  ...
  children: [
    {
      ...
      reserved: 9_127_181, spent: 26_862_860, children: QUALITY,
    },
    {
      id: 't-spread', label: 'المنح الانتشاري', alloc: 33_300_000, plan: 100,
      reserved: 10_376_400, spent: 17_787_741, children: SPREAD,
    },
  ],
}
...
export const CYCLES: Cycle[] = [
  { id: '2026-f', label: '2026 · المؤسسة', alloc: 73_600_000, approved: 64_154_182, reserved: 19_503_581, spent: 44_650_601, tree: plan2026, active: true },
  { id: '2025-f', label: '2025 · المؤسسة', alloc: 55_800_000, approved: 58_639_800, reserved: 896_000, spent: 57_743_800, active: false },
  { id: '2024-f', label: '2024 · المؤسسة', alloc: 47_200_000, approved: 47_475_359, reserved: 60_000, spent: 47_415_359, active: false },
  { id: '2023-f', label: '2023 · المؤسسة', alloc: 2_849_573, approved: 847_479, reserved: 0, spent: 847_479, active: false },
  { id: '2023-w', label: '2023 · الوقف', alloc: 1_000_000, approved: 0, reserved: 0, spent: 0, active: false },
]
