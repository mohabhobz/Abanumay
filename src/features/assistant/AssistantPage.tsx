 ...
 * ١ — مخرجات AI مساندة وغير مُلزِمة، فكل إجابة فيها قرار بتتعلّم في الواجهة.
 * ٢ — «لو الـAI هو المدخل الوحيد، اليوزر ممكن يتسحل في فلو ما يجاوبوش»،
 *     فالكروت اختصارات نتيجتها معروفة مش دعوات لمحادثة مفتوحة.
 * ٣ — التثبيت والبحث في المحادثات جزء أساسي مش زينة.
 */
