    ...
    <AppLayout assistantContext={assistFor.entity(entity)}>
      <div className="viewstack">
        <div className="screen col hasg2">
          ...
          {/* ═══ الرحلة بعرض الصفحة، برّه الترويسة ═══
              كانت جنب الهوية في نفس الصفّ، يعني عرضها نصّ عرض
              القسم اللي تحتها: ٦٥٤ مقابل ١٢٧٧ على ١٤٤٠، و٤٩٣
              مقابل ٩٥٤ على ١١٠٠. والشكل اللي بيقول «ده كل اللي
              اتمنح للجهة دي» ما ينفعش يبقى نصّ عرض جدول تحته،
              وفراغ كبير كان بيفضل جنبه.

              دلوقتي شريط بعرض الصفحة بين الترويسة والتابات ·
              نفس حدود القسم اللي تحته بالظبط. */}
          <div className="pflow">
